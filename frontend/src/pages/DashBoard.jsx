...
const DashBoard = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getCartItems()); // Load cart items on component mount
  }, [
    dispatch,
    searchTerm,
    currentPage,
  ...
  // Check if any modal is open or cart sidebar is open
  const isAnyModalOpen = showCategoryModal || showSubCategoryModal || showProductModal || showCartSidebar;
  ...
  return (
    <>
      <div className={`min-h-screen bg-white flex flex-col ${isAnyModalOpen ? 'blur-sm' : ''}`}>
        <div className="flex justify-between items-center p-4 bg-[#003f62] shadow-md">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex items-center gap-2 bg-[#FFBA00] hover:bg-[#FF6C00] text-white px-4 py-2 rounded-lg font-medium transition relative"
            >
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-3 flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="text-[#003b5c] hover:text-[#FFBA00] transition-colors"
                      >
                        <ShoppingCart size={18} />
                      </button>
                    </div>
    ...
    <Modal isOpen={showCategoryModal} onClose={() => setShowCategoryModal(false)}>
      <AddCategoryForm onClose={() => setShowCategoryModal(false)} />
    </Modal>

    <Modal isOpen={showSubCategoryModal} onClose={() => setShowSubCategoryModal(false)}>
      <AddSubCategoryPage onClose={() => setShowSubCategoryModal(false)} />
    </Modal>

    <Modal isOpen={showProductModal} onClose={() => setShowProductModal(false)}>
      <AddProductPage onClose={() => setShowProductModal(false)} />
    </Modal>
