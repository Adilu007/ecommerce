...
router.get("/getCart", protectedRoute, getCartItems);
router.delete("/removeFromCart/:productId", protectedRoute, removeFromCart);
router.delete("/clearCart", protectedRoute, clearCart);
